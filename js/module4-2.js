...
// // Умовно мутуючий - може змінювати масив, з котрим працює (але не обов'язково) - це залежить від передаваємої колбек функції
// // Для кожного перебираючого методу масиву потрібно розуміти:
// // 1. що він робіть
// // 2. що приймає
// // 3. що повертає
// // forEach() має 2 аргументи: колбек-функція та об'єкт, в контексті котрого буде викликатися цей колбек (або тільки 1 параметр - колбек функція)
