...
// Для кожного перебираючого методу масива потрібно розумыти:
// 1. що він робе
// 2. що приймає
// 3. що повертає
...
// // // ❗️❗️❗️ Метод find()
// // Меиод виконує пошук першого збігу в масиві. Повертає елемент, для якого колбек-функція повернула true, після чого припиняє пошук. Якщо не знайдено жодного елемента, выдповыдаючего умовы, то повертаэться undefind.
