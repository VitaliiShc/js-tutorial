...
// Колбек-функція - це посилання на функцію, яка лежить десь в глобвльної області видимості. В виклик одної функції передаеться посилання на іншу функцію
...
// Мутуючий - може змінювати масив, з котрим працює (але не обов'язково)
...
// // ❗️❗️❗️ Стрілочні функції - використовуються якщо потрібно отримати змінну як результат виколнання функції. Після стрілки ( => ) ставиться ії тіло. Стрілочні функції не можуть використовуватися як метод об'екту
...
// const sum2 = (a, b) => a + b; // нееявне повернення. повретається результат виразу. Використовується тільки коли функціі не потрібне виконувати додаткових інструкцій, а потрібно повернути якесь значення
...
// Використовується, щои закрити доступ до змін приватних хмінних, да повертати тільки методи (вкалдені функції) для роботи за вихідними приватними данимі - область дій з данимі огранічена тільки доступнимі (оголошенимі) методамі/функціямв
