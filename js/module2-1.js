...
// // метод unshift(value, value...) - додає один або кілька вказаних єлементів на початку масиву. Деструктівний(!), для збереження орігінального масиву метод треба виконувати на копії (робиться через splice()). Повертає довжину нову масиву
// const array = ['One', 'Two', 'Three'];
