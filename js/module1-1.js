...
// and && - повертає перший false, або останній true (толбто, зупинається на false, та повертає його значення; якщо всы операнди були приведені до true - полвертається останне значення).
