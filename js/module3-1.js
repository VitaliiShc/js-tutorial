...
// Об'ект це не індексована та не ітерабельна сутність. Звернення до властивостей виконується до ключах, та іх місце в об'екті не має значення.
...
user2.name = 'Denys';
console.dir(user2); // Змінено тільки ім'я, все останне береться з прототипу

// Прототипне наслідування

// Метод hasOwnProperty()
// Повертає буль приналежності влвтивості тої сутності (об'екту) для котрого він викликаний (при роботі з протипованнимі об'ектамі)

// Метод Object.keys()
// Повертає масив ключів об'екиту ['key0', 'key1', ... 'keyZ']

// Метод Object.values()
// Повертає масив значень ключів об'екта ['value0', 'value1',...'valueZ']
